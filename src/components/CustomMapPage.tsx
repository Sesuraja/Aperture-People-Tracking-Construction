...
export default function CustomMapPage({ activeProject, setActiveProject }: CustomMapPageProps) {
  ...
  // Save Geofenced Area to Firestore
          ...
          <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-4 shadow-sm space-y-4">
            <div className="grid grid-cols-3 gap-1 p-1 bg-slate-100 dark:bg-slate-900 rounded-xl">
              <button
                ...
                className={`py-1.5 text-[10px] font-extrabold rounded-lg transition ${activeSidebarTab === 'layers' ? 'bg-white dark:bg-slate-800 text-[#007BC4] shadow' : 'text-slate-500'}`}
              >
                Layers
              </button>
              <button
                onClick={() => setActiveSidebarTab('zones')}
                className={`py-1.5 text-[10px] font-extrabold rounded-lg transition ${activeSidebarTab === 'zones' ? 'bg-white dark:bg-slate-800 text-[#007BC4] shadow' : 'text-slate-500'}`}
              >
                Geofences
              </button>
              <button
                onClick={() => setActiveSidebarTab('inventory')}
                className={`py-1.5 text-[10px] font-extrabold rounded-lg transition ${activeSidebarTab === 'inventory' ? 'bg-white dark:bg-slate-800 text-[#007BC4] shadow' : 'text-slate-500'}`}
              >
                Personnel
              </button>
            </div>
